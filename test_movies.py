...
class TestMoviesEndpoints:
    ...
    def test_get_movies_list(self, client, sample_movies):
    ...
    def test_get_movie_not_found(self, client, sample_movies):
    ...
    def test_create_movie(self, client, db):
        ...
        # Verify in database
        get_response = client.get("/movies/100")
        assert get_response.status_code == status.HTTP_200_OK
        assert get_response.json()["title"] == "Test Movie (2024)"

    def test_create_movie_duplicate(self, client, sample_movies):
    ...
    def test_update_movie_not_found(self, client, sample_movies):
        ...
        response = client.put("/movies/9999", json=updated_data)
    ...
    def test_delete_movie_not_found(self, client, sample_movies):
